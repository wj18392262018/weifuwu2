                ...
                <div class="tab-content tab-wraped">
                    ...
                    <div id="profile" class="tab-pane  active">
                        ...
                        <form class="sui-form">
                            ...
                            <div class="logined">
                                <a class="sui-btn btn-block btn-xlarge btn-danger" @click="login"
                                   href="javascript:" onclick="f1()">登&nbsp;&nbsp;录</a>
                            </div>
                        </form>
                        <div class="otherlogin">
                            ...
                            <span class="register"><a href="${pageContext.request.contextPath}/register.html" target="_blank">立即注册</a></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function f1() {
        ...
        location.href="${pageContext.request.contextPath}/category/logUser?username="+username+"&&password="+password;
    }
</script>
</html>